...
<head>
    ...
    <title>Clear Deployment</title>
</head>
<body>
    <h3>CLEANING DEPLOYMENT IN REPOSITORY GITHUB (RECOMMENDED DISCONNECT TO HEROKU)</h3>
    <label for="token">masukan token</label> <br>
    <input type="text" id="token"> <br>

    <label for="repo">masukan repo</label> <br>
    <input type="text" id="repo"> <br>

    <label for="username">masukan username</label> <br>
    <input type="text" id="username"> <br>

    <button id="button" onclick="kirim()">Remove</button>
    ...
    function kirim(){
        ...
        const USER_OR_ORG = document.getElementById("username").value;
